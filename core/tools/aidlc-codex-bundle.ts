...
const ACTIVE_TOOL_FILES = [
  ...
  "aidlc-vnext-requirements-contract.ts",
  "aidlc-vnext-requirements.ts",
  "aidlc-vnext-architecture-contract.ts",
  "aidlc-vnext-architecture.ts",
  "aidlc-vnext-build-contract-contract.ts",
  "aidlc-vnext-build-contract.ts",
  "aidlc-vnext-build-converge-contract.ts",
  "aidlc-vnext-build-converge.ts",
  "aidlc-vnext-review-contract.ts",
  "aidlc-vnext-review.ts",
  "aidlc-vnext-release-contract.ts",
  "aidlc-vnext-release.ts",
  "aidlc-vnext-outcome-contract.ts",
  "aidlc-vnext-outcome.ts",
