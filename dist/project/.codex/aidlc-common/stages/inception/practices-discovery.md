...
```bash
./.codex/tools/aidlc state practices-event --project-dir . \
  --type discovered \
...
1. Open the gate before the question:
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage
...
```bash
./.codex/tools/aidlc state practices-promote --project-dir . \
