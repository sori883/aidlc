...
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.codex/knowledge/aidlc-aws-platform-agent/` for AWS service mapping.
Load aidlc-design-agent persona from `agents/aidlc-design-agent.md` and knowledge from `.codex/knowledge/aidlc-design-agent/` for UI component specifications and UX-informed design constraints.
...
`./.codex/tools/aidlc orchestrate report --project-dir . --stage application-design --result <outcome>`.
...
`./.codex/tools/aidlc utility recompose --project-dir . --add units-generation`
