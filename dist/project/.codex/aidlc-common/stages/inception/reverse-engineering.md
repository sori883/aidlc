...
`./.codex/tools/aidlc orchestrate report --project-dir . --stage reverse-engineering --result skipped --reason "<reason>"`.
...
```
./.codex/tools/aidlc utility codekb-path --project-dir . --repo <repo>
```
...
`./.codex/tools/aidlc orchestrate report --project-dir . --stage reverse-engineering --result <outcome>`.
