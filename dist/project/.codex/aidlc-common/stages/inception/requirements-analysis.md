...
`./.codex/tools/aidlc orchestrate report --project-dir . --stage requirements-analysis --result <outcome>`.
...
`./.codex/tools/aidlc utility recompose --project-dir . --add user-stories`
