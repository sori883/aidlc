...
`./.codex/tools/aidlc orchestrate report --project-dir . --stage delivery-planning --result <outcome>`.
...
`./.codex/tools/aidlc state set-construction-iteration --project-dir . unit-major`.
