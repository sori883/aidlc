...
Run `./.codex/tools/aidlc utility detect --project-dir . --json`. Returns workspace scan
...
```
./.codex/tools/aidlc graph ars --iae <s> --csu <s> --ve <s> --r <s> --ua <s> [--completed <csv>] [--project-type <t>]
```
...
```
./.codex/tools/aidlc graph validate-grid --proposal <path> --project-type <greenfield|brownfield>
```
...
```
./.codex/tools/aidlc graph validate-grid --proposal <path> --keywords <granted,csv>
```
