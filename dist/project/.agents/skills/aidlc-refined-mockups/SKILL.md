...
description: Run the AI-DLC refined-mockups Stage in isolation without advancing the active Intent.
---
...
Run the `refined-mockups` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage refined-mockups --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage refined-mockups --result completed --single`
