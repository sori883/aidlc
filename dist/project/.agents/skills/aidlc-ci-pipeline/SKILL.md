...
description: Run the AI-DLC ci-pipeline Stage in isolation without advancing the active Intent.
---
...
Run the `ci-pipeline` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage ci-pipeline --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage ci-pipeline --result completed --single`
