...
description: Run the AI-DLC environment-provisioning Stage in isolation without advancing the active Intent.
---
...
Run the `environment-provisioning` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage environment-provisioning --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage environment-provisioning --result completed --single`
