...
description: Run the AI-DLC feedback-optimization Stage in isolation without advancing the active Intent.
---
...
Run the `feedback-optimization` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage feedback-optimization --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage feedback-optimization --result completed --single`
