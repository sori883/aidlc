...
description: Run the AI-DLC feasibility Stage in isolation without advancing the active Intent.
---
...
Run the `feasibility` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage feasibility --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage feasibility --result completed --single`
