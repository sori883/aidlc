...
description: Run the AI-DLC incident-response Stage in isolation without advancing the active Intent.
---
...
Run the `incident-response` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage incident-response --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage incident-response --result completed --single`
