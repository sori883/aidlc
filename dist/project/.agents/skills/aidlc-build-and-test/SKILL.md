...
description: Run the AI-DLC build-and-test Stage in isolation without advancing the active Intent.
---
...
Run the `build-and-test` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage build-and-test --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage build-and-test --result completed --single`
