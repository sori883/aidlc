...
description: Run the AI-DLC market-research Stage in isolation without advancing the active Intent.
---
...
Run the `market-research` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage market-research --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage market-research --result completed --single`
