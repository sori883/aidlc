...
description: Run the AI-DLC units-generation Stage in isolation without advancing the active Intent.
---
...
Run the `units-generation` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage units-generation --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage units-generation --result completed --single`
