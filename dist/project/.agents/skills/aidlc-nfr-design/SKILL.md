...
description: Run the AI-DLC nfr-design Stage in isolation without advancing the active Intent.
---
...
Run the `nfr-design` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage nfr-design --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage nfr-design --result completed --single`
