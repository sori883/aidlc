...
description: Run the AI-DLC performance-validation Stage in isolation without advancing the active Intent.
---
...
Run the `performance-validation` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage performance-validation --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage performance-validation --result completed --single`
