...
1. Request the isolated directive:
   ...
   `./.aidlc/bin/aidlc orchestrate next --project-dir . --stage infrastructure-design --single`
...
4. Record the isolated lifecycle:
   ...
   `./.aidlc/bin/aidlc orchestrate report --project-dir . --stage infrastructure-design --result completed --single`
