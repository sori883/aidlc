...
description: Run the AI-DLC infrastructure-design Stage in isolation without advancing the active Intent.
---
...
Run the `infrastructure-design` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage infrastructure-design --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage infrastructure-design --result completed --single`
