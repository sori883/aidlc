...
1. Request the isolated directive:
   ...
   `./.aidlc/bin/aidlc orchestrate next --project-dir . --stage practices-discovery --single`
...
4. Record the isolated lifecycle:
   ...
   `./.aidlc/bin/aidlc orchestrate report --project-dir . --stage practices-discovery --result completed --single`
