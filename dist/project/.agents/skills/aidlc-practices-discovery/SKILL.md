...
description: Run the AI-DLC practices-discovery Stage in isolation without advancing the active Intent.
---
...
Run the `practices-discovery` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage practices-discovery --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage practices-discovery --result completed --single`
