...
description: Run the AI-DLC user-stories Stage in isolation without advancing the active Intent.
---
...
Run the `user-stories` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage user-stories --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage user-stories --result completed --single`
