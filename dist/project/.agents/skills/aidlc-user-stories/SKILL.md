...
1. Request the isolated directive:
   ...
   `./.aidlc/bin/aidlc orchestrate next --project-dir . --stage user-stories --single`
...
4. Record the isolated lifecycle:
   ...
   `./.aidlc/bin/aidlc orchestrate report --project-dir . --stage user-stories --result completed --single`
