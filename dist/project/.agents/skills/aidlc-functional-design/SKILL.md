...
1. Request the isolated directive:
   ...
   `./.aidlc/bin/aidlc orchestrate next --project-dir . --stage functional-design --single`
...
4. Record the isolated lifecycle:
   ...
   `./.aidlc/bin/aidlc orchestrate report --project-dir . --stage functional-design --result completed --single`
