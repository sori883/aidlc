...
description: Run the AI-DLC functional-design Stage in isolation without advancing the active Intent.
---
...
Run the `functional-design` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage functional-design --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage functional-design --result completed --single`
