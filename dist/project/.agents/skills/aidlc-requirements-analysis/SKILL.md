...
description: Run the AI-DLC requirements-analysis Stage in isolation without advancing the active Intent.
---
...
Run the `requirements-analysis` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage requirements-analysis --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage requirements-analysis --result completed --single`
