...
description: Run the AI-DLC intent-capture Stage in isolation without advancing the active Intent.
---
...
Run the `intent-capture` Stage once. This is explicit packaging over
