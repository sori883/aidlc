...
description: Run the AI-DLC approval-handoff Stage in isolation without advancing the active Intent.
---
...
Run the `approval-handoff` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage approval-handoff --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage approval-handoff --result completed --single`
