...
description: Run the AI-DLC reverse-engineering Stage in isolation without advancing the active Intent.
---
...
Run the `reverse-engineering` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage reverse-engineering --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage reverse-engineering --result completed --single`
