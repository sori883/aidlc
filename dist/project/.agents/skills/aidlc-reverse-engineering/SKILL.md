...
1. Request the isolated directive:
   ...
   `./.aidlc/bin/aidlc orchestrate next --project-dir . --stage reverse-engineering --single`
...
4. Record the isolated lifecycle:
   ...
   `./.aidlc/bin/aidlc orchestrate report --project-dir . --stage reverse-engineering --result completed --single`
