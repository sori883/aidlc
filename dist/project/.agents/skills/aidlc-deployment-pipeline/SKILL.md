...
description: Run the AI-DLC deployment-pipeline Stage in isolation without advancing the active Intent.
---
...
Run the `deployment-pipeline` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage deployment-pipeline --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage deployment-pipeline --result completed --single`
