...
description: Run the AI-DLC code-generation Stage in isolation without advancing the active Intent.
---
...
Run the `code-generation` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage code-generation --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage code-generation --result completed --single`
