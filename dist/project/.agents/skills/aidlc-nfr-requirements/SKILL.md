...
description: Run the AI-DLC nfr-requirements Stage in isolation without advancing the active Intent.
---
...
Run the `nfr-requirements` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage nfr-requirements --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage nfr-requirements --result completed --single`
