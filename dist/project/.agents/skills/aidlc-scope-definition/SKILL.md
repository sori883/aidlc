...
description: Run the AI-DLC scope-definition Stage in isolation without advancing the active Intent.
---
...
Run the `scope-definition` Stage once. This is explicit packaging over
...
1. Request the isolated directive:
   ...
   `./.codex/tools/aidlc orchestrate next --project-dir . --stage scope-definition --single`
...
4. Record the isolated lifecycle:
   ...
   `./.codex/tools/aidlc orchestrate report --project-dir . --stage scope-definition --result completed --single`
