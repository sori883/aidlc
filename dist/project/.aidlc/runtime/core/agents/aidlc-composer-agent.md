...
Run `./.aidlc/bin/aidlc utility detect --project-dir . --json`. Returns workspace scan
...
```
./.aidlc/bin/aidlc graph ars --iae <s> --csu <s> --ve <s> --r <s> --ua <s> [--completed <csv>] [--project-type <t>]
```
...
```
./.aidlc/bin/aidlc graph validate-grid --proposal <path> --project-type <greenfield|brownfield>
```
...
```
./.aidlc/bin/aidlc graph validate-grid --proposal <path> --keywords <granted,csv>
```
