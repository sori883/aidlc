...
Load aidlc-architect-agent (lead) persona from `agents/aidlc-architect-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-architect-agent/`. Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-aws-platform-agent/` for infrastructure and platform input. Apply aidlc-architect-agent as the primary perspective with aidlc-aws-platform-agent providing domain-specific input.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage nfr-design --result <outcome>`.
