...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage reverse-engineering --result skipped --reason "<reason>"`.
...
Template in
`.aidlc/runtime/core/knowledge/aidlc-developer-agent/re-artifacts.md`.
...
```
./.aidlc/bin/aidlc utility codekb-path --project-dir . --repo <repo>
```
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage reverse-engineering --result <outcome>`.
