...
Load aidlc-design-agent persona from `agents/aidlc-design-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-design-agent/`.
...
Create mid-to-high fidelity mockups (per user story/screen), interaction specification document (use `.aidlc/runtime/core/knowledge/aidlc-design-agent/component-spec-template.md` as the format for component-level specifications), design system mapping, responsive behavior specification, and accessibility compliance checklist.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage refined-mockups --result <outcome>`.
