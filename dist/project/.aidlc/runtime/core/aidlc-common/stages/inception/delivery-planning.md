...
Load aidlc-delivery-agent persona from `agents/aidlc-delivery-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-delivery-agent/`.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage delivery-planning --result <outcome>`.
...
`./.aidlc/bin/aidlc state set-construction-iteration --project-dir . unit-major`.
