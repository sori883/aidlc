...
Load aidlc-product-agent persona from `agents/aidlc-product-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-product-agent/`.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage requirements-analysis --result <outcome>`.
...
`./.aidlc/bin/aidlc utility recompose --project-dir . --add user-stories`
