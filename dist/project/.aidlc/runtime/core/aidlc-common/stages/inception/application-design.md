...
Load aidlc-architect-agent persona from `agents/aidlc-architect-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-architect-agent/`.
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-aws-platform-agent/` for AWS service mapping.
Load aidlc-design-agent persona from `agents/aidlc-design-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-design-agent/` for UI component specifications and UX-informed design constraints.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage application-design --result <outcome>`.
...
`./.aidlc/bin/aidlc utility recompose --project-dir . --add units-generation`
