...
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-aws-platform-agent/`.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage environment-provisioning --result <outcome>`.
