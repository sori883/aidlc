...
Load aidlc-operations-agent persona from `agents/aidlc-operations-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-operations-agent/`.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage feedback-optimization --result <outcome>`.
