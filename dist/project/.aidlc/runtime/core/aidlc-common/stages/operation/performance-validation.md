...
Load aidlc-quality-agent persona from `agents/aidlc-quality-agent.md` and knowledge from `.aidlc/runtime/core/knowledge/aidlc-quality-agent/`.
...
`./.aidlc/bin/aidlc orchestrate report --project-dir . --stage performance-validation --result <outcome>`.
